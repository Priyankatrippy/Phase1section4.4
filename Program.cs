...
namespace Phase1Section4._4
{
    internal class Program
    {
        ...
        public static void runApp()
        {
            ...
            students3A = new string[10]
            {"rahul","sheela",",mukesh" ,"Afzal", "Ramesh", "Geeta", "Jason", "Robert", "Gopal", 
                 "Meera" };
            students3B= new string[10]{ "Pinky", "Rakesh", "Rafi", "Mumtaz",
                 "Derek", "Sukhwinder", "Gopi", "Tulsi", "Chandrika", "Ann"
            };
        ...
        Console.WriteLine("Students of Class 3A:");
...

            {
             ...
             Console.WriteLine("");
                ...
                Console.WriteLine("Students of Class 3B:"); foreach (string s in students3B)
